...
Route::get('/my-api', [EmploymentController::class, 'getSheetData']);
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('master-data/list-non-permanent', [EmploymentController::class, 'listNonPermanent'])->name('listNonPermanent');
