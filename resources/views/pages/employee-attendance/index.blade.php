    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div id="chartContainer" class="grid grid-cols-1 xl:grid-cols-2 gap-6 hidden">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">
                       5 Unit kerja dengan jumlah ketidak hadiran terbanyak
                    </h2>
                </header>
                <div class="p-3">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">
                        Total Waktu Libur per Departemen
                    </h2>
                </header>
                <div class="p-3">
                    <div class="overflow-x-auto">
                        <canvas id="timeOffChart" width="400" height="300"></canvas>
                    </div>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">
                        Top 10 Karyawan dengan Rasio Kehadiran Tepat Waktu Tertinggi
                    </h2>
                </header>
                <div class="p-3">
                    <div class="overflow-x-auto">
                        <canvas id="onTimeAttendanceChart" width="400" height="300"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">
                       Top 10 Karyawan dengan Keterlambatan Terbanyak
                    </h2>
                </header>
                <div class="p-3">
                    <div class="overflow-x-auto">
                        <canvas id="lateEmployeesChart" width="400" height="300"></canvas>
                    </div>
                </div>
            </div>
        </div>
