@vite(['resources/js/master-data/employee-non-permanen/index.js'])
...
<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Master Employee Non Permanent</h1>
            </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <button id="uploadEmployeeBtn" class="btn bg-indigo-500 text-white hover:bg-indigo-600">
        ...
        <div class="container mx-auto p-6">
            ...
            <div class="overflow-x-auto">
                <table id="employeeTableNonPermanent" class="min-w-full divide-y divide-gray-200 text-sm">
    ...
    <div id="uploadModalEmployee" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 hidden">
